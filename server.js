...
// ============================================
const MONGODB_PASSWORD = process.env.MONGODB_PASSWORD || 'Test123456';

const uri = `mongodb+srv://fristtrydb:${MONGODB_PASSWORD}@firstcluster.awquwo3.mongodb.net/?retryWrites=true&w=majority&appName=firstcluster`;
